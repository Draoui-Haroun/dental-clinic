...
export default function PatientsClient({
  ...
  return (
    <main className="p-4 sm:p-6 lg:p-8">
      ...
      {showForm && (
        <section className="mb-8 rounded-2xl border border-gray-200 bg-gray-50 p-5 shadow-sm sm:p-6">
          <div className="mb-6">
          ...
          <button
            ...
            className="mt-3 rounded-lg border px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50"
          >
            Annuler
          </button>
        </section>
      ...
      <section className="mb-6">
        <div className="relative">
          <input
            ...
            className="w-full rounded-xl border bg-white px-4 py-3 text-sm text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-gray-400 focus:ring-2 focus:ring-gray-100"
          />
        </div>
